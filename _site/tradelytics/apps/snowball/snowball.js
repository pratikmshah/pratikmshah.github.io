...
var ETF = {
  ...
  XHB:"LOW,HD,WSM,PHM,NVR,DHI,WHR,JCI,MAS,FBHS,LEN,BBBY,MHK,TOL,OC,ALLE,LII,USG,AOS,LEG,TPX,TPH,TMHC,AAN,TREX,AWI,LGIH,MDC,BLD,HELE,IBP,WLH,CCS,CVCO,MHO",

  ITB:"DHI,LEN,NVR,PHM,HD,TOL,LOW,BLD,TPH,SHW,TMHC,KBH,CVCO,MTH,MHK,MAS,LII,MDC,FBHS,WSO,EXP,IBP,USG,LEG,OC,TREX,LPX,SSD,LGIH,UFPI,DOOR,FND,BECN,JELD,BLDR,CCS,MHO,WLH,PGTI,LENB,AMWD,NX,LL,ETH,BZH,TTS,HOV",

  ARKK:"TSLA,SSYS,NTLA,TWTR,ILMN,EDIT,BIDU,NVTA,ATHN,SQ,TER,AMZN,NSTG,JD,LC,NFLX,AAPL,NVDA,BLUE,CERS,MDSO,APTV,TCEHY,XLNX,CRM,MCRB,SYRS,SPOT,RDFN,VCYT,PACB,CRSP,CGEN,MTLS,ONVO,BABA,SPLK,RHT,MSFT,TSM,MELI,XONE,GBTC,MGTI,INO,FB"
}
