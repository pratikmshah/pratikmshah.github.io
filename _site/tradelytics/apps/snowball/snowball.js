...
var ETF = {
  ...
  BLOK:"TSM,SQ,OSTK,IBM,RHT,GOOGL,AMD,ORCL,C,GS,SAP,ACN,INTC,BIDU,NVDA,MSFT,NDAQ,BABA,CME,TRI,JD,INFY,WIT,XNET,BBVA,CSCO,UBS,STX,SAN,FISV,JPM,QCOM,V,QIWI,AXP,SIVB,GCAP,CBOE,MA,KODK",

  KRE:"STI,KEY,CIT,CMA,MTB,HBAN,RF,PNC,PBCT,FRC,CFG,CFR,BBT,TCF,FITB,FHN,SIVB,BPOP,ZION,PACW,EWBC,TCBI,STL,ASB,SNV,UMPQ,FNB,SBNY,WTFC,PNFP,WAL,OZK,BKU,ISBC,CBSH,WBS,IBKC,VLY,PB,HWC,BXS,UBSI,BOH,MBFI,HOMB,PPBI,CHFC,CSFL,ONB,FULT,CATY,BOKF,UBSH,GBCI,UMBF,FCB,UCBI,FMBI,BANR,CBU,FBP,FFBC,COLB,LTXB,SSB,FFIN,ABCB,SFNC,CADE,HOPE,BANC,FHB,IBTX,GWB,FCF,TRMK,SBCF,CVBF,HTH,IBOC,FIBK,NBHC,EGBN,RNST,SASR,WABC,INDB,FRME,SFBS,EFSC,BHLB,HTLF,HFWA,PFBC,HAFC,BPFH,TBK,CHCO,BRKL,OPB,SBSI,GNBC,CPF,CNOB,OFG,CUBI,NBTB,FBK,STBZ,LOB,UVSP,VBTX,TSC,IBCP,CARO,LION,GBNK,TBBK,MSBI,LBAI,PGC,EQBK,FSB",

  IBUY:"CVNA,TRIP,W,ETSY,SFIX,GRUB,LE,EXPE,NTRI,FLWS,AMZN,IAC,PYPL,STMP,PETS,CPRT,NFLX,OSTK,BKNG,QRTEA,SFLY,EBAY,CMPR,MELI,SHOP,CTRP,BABA,JD,MMYT,VIPS",

  PKW:"DIS,CHTR,GM,MAR,YUM,ORLY,BBY,CBS,DPZ,KORS,PHM,GT,FL,SIX,TOL,URBN,WYND,AN,ILG,CHDN,MIK,H,SIG,VC,AMCX,RH,BBBY,MUSA,BLD,TPX,JACK,TEN,EAT,TPH,LAD,SBH,DDS,BIG,BLMN,ABG,PZZA,SONC,BJRI,CROX,SNBR,DENN,RGR,CATO,WINA,TRNC,SCVL,CRMT,HIBB,CTRN,BPI,DFRG,PG,WBA,KR,CAG,HLF,SFM,SAM,MPC,C,AXP,GS,AIG,DFS,SYF,AMP,RF,FITB,HIG,ALLY,VOYA,CACC,CIT,AIZ,AXS,AGO,NAVI,WTM,LM,KRNY,MBI,GHL,HRTG,GCAP,FNHC,CVS,ESRX,HCA,MCK,IQV,DVA,MEDP,BABY,PRSC,PDLI,UAL,INFO,AAL,HDS,ALSN,TEX,FCN,CAR,TILE,CBPX,NCS,RECN,BW,EBAY,GLW,WP,VRSN,WU,CDK,AZPN,UBNT,AVT,TDC,CE,SEE,KALU,SBAC,SRC,RLGY,JOE",

  NOBL:"LOW,GWW,VFC,CLX,CTAS,ADP,TGT,SHW,MKC,MDT,PEP,ABT,PX,PG,FRT,KMB,GPC,SYY,TROW,DOV,WBA,NUE,ROP,BDX,KO,SPGI,JNJ,ADM,CVX,WMT,XOM,AFL,BEN,SWK,EMR,LEG,PPG,ED,CL,HRL,MCD,CINF,ABBV,APD,BF.B,MMM,ECL,PNR,T,AOS,ITW,GD,CAH"
}
