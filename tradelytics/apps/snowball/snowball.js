...
$(function() {
  ...
  function displayCharts(arr, sym) {
    ...
    for (var i = 0; i < arr.length; i++) {
      $chart.append('<div class="chart-container"> <img src=' + arr[i] + ' class="chart" data-border-color="black" /> <input type="checkbox"  name="watchlist" value=' + sym[i].toUpperCase() + '> <a href="https://finviz.com/quote.ashx?t=' + sym[i].toUpperCase() + '" target="_blank" class="chart-link"> <i class="glyphicon glyphicon-new-window"></i> </a>  </div>');
    }
