...
12. [User Forms](#userforms)
- [Hide Show & Unload](#hideshow)
- [Status Box](#status)
- [New Data](#newdata)
- [Convert to Numbers](#txt2num)
- [Tab Order](#taborder)
- [Default Value](#defval)
- [Prevent Duplicate](#duplicate)
- [Edit Mode](#editmode)
- [Report w Filters](#reportfilter)
...
### User Forms <a name="userforms"></a>
#### Hide Show & Unload <a name="hideshow"></a>
...
#### Convert Text to Numbers <a name="txt2num"></a>
...
#### Default Value <a name="defval"></a>
To set a default value in a textbox set it in the `caption` property.

<br>

#### Prevent Duplicates <a name="duplicate"></a>
...
#### Reports w Filters <a name="reportfilter"></a>
