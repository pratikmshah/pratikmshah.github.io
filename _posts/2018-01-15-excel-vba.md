...
The `Do Until` forces you to specify a condition so that when true it will break out of the loop. You can still have an infinite loop if the condition never reaches true.
