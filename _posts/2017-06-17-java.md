...
### Table of Contents
 ...
 - [Booleans](#bool)
 - [Strings](#str)
 - [Java 7 Enhancements](#j7data-type)
 3. [Control Flow](#ctrl)
 - [Conditionals](#condition)
 - [Switch Statement](#switch)
 - [Switch Java 7+](#j7switch)
 - [Loops](#loop)
 - [Method](#method)
...
#### Java 7 Enhancements <a name="j7data-type"></a>
...
#### Switch - Java 7 <a name="j7switch"></a>
...
The hash set is a `Set` which means that each object can only appear once in the set. The hash set is a bit faster than the tree set.
